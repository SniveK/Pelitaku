...
if ($_SERVER["REQUEST_METHOD"] == "POST" && $_POST["submit"] == "FINAL") {
    $sql = "INSERT INTO `class_session` ( `class_subject`, `tutor_id`, `tutee_id`, `date`, `time_start`, `time_end`, `completed`)VALUES (`" . $_POST["subject-tutor"] . "`, `" . $_POST["tutor-id"] . "`, `" . $_SESSION["id"] . "`, `" . $_POST["date"] . "`, `" . $_POST["time_start"] . "`, `" . $_POST["time_end"] . "`, `0`)";
    echo $sql;
    ...
    <div class="flex-container-row flex-center">
        <div class="flex-container-column flex-center width-1280 margin-top-82 margin-bottom-82 row-gap-40">
            ...
            <form action="./calendar_booking.php" method="POST">
                <input class="background-transparent add-arrow-right width-650 text-align-left" type="submit" value="<?php echo (isset($_POST["time_start"])) ? $_POST["time_start"] . "-" . $_POST["time_end"]   : "Pilih Waktu?" ?>">

...
<body>
    ...
    <div class="flex-container-column flex-center ">
        ...
        <div class="flex-container-column width-1280 margin-bottom-82 line-height-30 row-gap-20 font-size-18 text-align-justify">
            ...
            <div>Selain sesi tutor <i>1on1</i>, Pelitaku juga menyediakan event Group Tutoring untuk kalian yang ingin mengikuti sesi tutor bersama teman kalian dalam kelompok kecil.</div>
        </div>
    </div>
